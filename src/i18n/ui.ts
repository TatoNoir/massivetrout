...
export const ui = {
  en: {
    ...
    "cowboy.title": "Before you visit Cowboy Drifters",
    "cowboy.text":
      "Subscribe to our newsletter to keep up with our trips, scouting reports, and destination updates.",
    "cowboy.confirm": "Subscribe & visit Cowboy Drifters",
    "cowboy.success": "Subscription received. Taking you to Cowboy Drifters…",
  ...
  es: {
    ...
    "cowboy.title": "Antes de visitar Cowboy Drifters",
    "cowboy.text":
    ...
    "cowboy.confirm": "Suscribirme y visitar Cowboy Drifters",
    "cowboy.success": "Suscripción recibida. Te llevamos a Cowboy Drifters…",
