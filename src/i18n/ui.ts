...
export const ui = {
  en: {
    ...
    "nav.programs.usa": "🇺🇸 EEUU",
    "nav.destinations": "Destinations",
    "nav.destinations.patagonia": "🇦🇷 Patagonia",
    "nav.destinations.corrientes": "🇦🇷 Corrientes",
    "nav.destinations.wyoming": "🇺🇸 Wyoming",
    "nav.story": "Story",
    "nav.lodges": "Lodges & Lodging",
    "nav.nonanglers": "Non-anglers",
    "nav.contact": "Contact",
    ...
    "cowboy.title": "Before you visit Wyoming Anglers",
    "cowboy.text":
      "Subscribe to our newsletter to keep up with our trips, scouting reports, and destination updates.",
    "cowboy.confirm": "Subscribe & visit Wyoming Anglers",
    "cowboy.success": "Subscription received. Taking you to Wyoming Anglers…",
    "cowboy.error": "There was a problem. Please try again.",
    "cowboy.close": "Close dialog",
    ...
    "reviews.title": "What our anglers say about us",
    "reviews.videoTitle": "Nick Warren — DJ and Producer",
  ...
  es: {
    ...
    "cowboy.title": "Antes de visitar Wyoming Anglers",
    "cowboy.text":
      "Suscribite a nuestro newsletter para mantenerte al día con nuestros viajes, reportes de pesca y actualizaciones de destinos.",
    "cowboy.confirm": "Suscribirme y visitar Wyoming Anglers",
    "cowboy.success": "Suscripción recibida. Te llevamos a Wyoming Anglers…",
    "cowboy.error": "Hubo un problema. Intentá de nuevo.",
    "cowboy.close": "Cerrar diálogo",
    ...
    "reviews.title": "Lo que dicen nuestros pescadores",
    "reviews.videoTitle": "Nick Warren — DJ y Productor",
